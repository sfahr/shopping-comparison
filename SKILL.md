---
name: shopping
description: Browse and purchase items on online shops using a real browser. Use when shopping finding products, comparing options, or buying things online.
...
### 1. Open Amazon
```
mcp__chrome-devtools__new_page → url: "https://www.amazon.de"
```
